...
public class doctors {
    ...
    public void set_values(String last_name, String first_name, String gender, String birthdate, float consultation_rate, long mobile_number, String email_address, String specialization) {
    ...
    public boolean remove_doctor(int doctorID) {
        try {
            ...
            // Delete the patient
            PreparedStatement ps = conn.prepareStatement("DELETE FROM doctor_speci WHERE doctor_id = ?;");
    ...
    public boolean get_related_specializations() {
        try {
            // Connect to database
            Class.forName("com.mysql.cj.jdbc.Driver");
            // Database connection details
            ...
            while (rs.next()) {
                ...
                mobile_number = rs.getLong("mobile_number");
                email_address = rs.getString("email_address");
                specialization = rs.getString("title");
    ...
    public boolean get_related_visits(visits v) {
        try {
            // Connect to database
            Class.forName("com.mysql.cj.jdbc.Driver");
            // Database connection details
            ...
            // Display all patients
            PreparedStatement ps = conn.prepareStatement("SELECT d.*, p.last_name, p.first_name, v.log_in, v.log_out, a.name " +
                "FROM doctors d" +
